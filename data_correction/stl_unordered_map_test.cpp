...
//typedef std::unordered_map<int64_t, int64_t>::size_type hash_s;
//typedef std::unordered_map<int64_t, int64_t, std::function<int64_t(int64_t)>, std::function<bool(int64_t,int64_t)> > hash_t;
